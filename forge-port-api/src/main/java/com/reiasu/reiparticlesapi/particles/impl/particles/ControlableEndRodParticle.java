...
public final class ControlableEndRodParticle extends ControlableParticle {
    private final SpriteSet provider;

    public ControlableEndRodParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControlableEndRodEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControlableEndRodEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControlableEndRodParticle(world,
