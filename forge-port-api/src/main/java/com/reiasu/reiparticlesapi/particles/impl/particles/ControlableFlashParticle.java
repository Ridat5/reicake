...
import com.reiasu.reiparticlesapi.particles.impl.ControlableFlashEffect;
...
public final class ControlableFlashParticle extends ControlableParticle {
    private final SpriteSet provider;

    public ControlableFlashParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControlableFlashEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControlableFlashEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControlableFlashParticle(world,
