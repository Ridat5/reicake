...
import com.reiasu.reiparticlesapi.particles.impl.ControlableEnchantmentEffect;
...
public final class ControlableEnchantmentParticle extends ControlableParticle {
    private final SpriteSet provider;

    public ControlableEnchantmentParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControlableEnchantmentEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControlableEnchantmentEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControlableEnchantmentParticle(world,
