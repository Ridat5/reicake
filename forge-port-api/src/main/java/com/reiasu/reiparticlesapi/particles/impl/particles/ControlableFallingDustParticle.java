...
import com.reiasu.reiparticlesapi.particles.impl.ControlableFallingDustEffect;
...
public final class ControlableFallingDustParticle extends ControlableParticle {
    private float uo;
    private float vo;

    public ControlableFallingDustParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControlableFallingDustEffect> {
        @Override
        public Particle createParticle(ControlableFallingDustEffect parameters, ClientLevel world,
            ...
            return new ControlableFallingDustParticle(world,
