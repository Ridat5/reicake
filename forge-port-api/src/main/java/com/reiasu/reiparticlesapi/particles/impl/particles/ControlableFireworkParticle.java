...
import com.reiasu.reiparticlesapi.particles.impl.ControlableFireworkEffect;
...
public final class ControlableFireworkParticle extends ControlableParticle {
    private final SpriteSet provider;

    public ControlableFireworkParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControlableFireworkEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControlableFireworkEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControlableFireworkParticle(world,
