...
import com.reiasu.reiparticlesapi.particles.impl.ControlableSplashEffect;
...
public final class ControlableSplashParticle extends ControlableParticle {
    private final SpriteSet provider;

    public ControlableSplashParticle(ClientLevel world, Vec3 pos, Vec3 velocity,
    ...
    public static class Factory implements ParticleProvider<ControlableSplashEffect> {
        private final SpriteSet provider;
        ...
        @Override
        public Particle createParticle(ControlableSplashEffect parameters, ClientLevel world,
                                       double x, double y, double z,
                                       double velocityX, double velocityY, double velocityZ) {
            return new ControlableSplashParticle(world,
