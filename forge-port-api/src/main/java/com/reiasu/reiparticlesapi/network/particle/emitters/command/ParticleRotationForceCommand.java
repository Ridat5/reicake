...
/**
 * Applies a rotational (tangential) force to particles around a center axis.
 * The force direction is the cross product of the axis and the radial vector,
 * attenuated by inverse-power distance falloff.
 */
