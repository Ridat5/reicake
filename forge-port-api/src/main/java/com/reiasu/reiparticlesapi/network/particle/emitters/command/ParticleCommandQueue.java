...
public final class ParticleCommandQueue {
    ...
    public interface CommandPredicate {
        boolean test(ParticleCommand command, ControlableParticleData data, ControlableParticle particle);
    }
     ...
     */
    public void applyVelocity(ControlableParticleData data, ControlableParticle particle) {
