...
/**
 * Drives particles along a procedural 3D flow/vector field.
 * The field is computed from sine/cosine functions of position and time,
 * creating an organic turbulent motion pattern.
 */
