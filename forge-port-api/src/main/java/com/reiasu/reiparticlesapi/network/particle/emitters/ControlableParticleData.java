 ...
 * <p>
 * Fields are aligned with the original Fabric {@code ControlableParticleData}:
 ...
 */
public class ControlableParticleData implements SerializableData {
    ...
    public ControlableParticleData clone() {
        ControlableParticleData copy = new ControlableParticleData();
