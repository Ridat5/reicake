...
/**
 * Simple direct (straight-line) particle interpolator between two points.
 * Generates intermediate points along a line from the old position to the new position.
 */
