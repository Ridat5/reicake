...
/**
 * Drives sequenced particle animations by evaluating predicate conditions
 * each tick and adding/removing particles accordingly.
 *
 * @param <T> the concrete {@link SequencedParticleStyle} type
 */
