...
/**
 * Fluent builder that converts an image resource into a map of
 * {@link RelativeLocation} to ARGB colour int values.
 * <p>
 * Non-transparent pixels are mapped to points in the XZ plane,
