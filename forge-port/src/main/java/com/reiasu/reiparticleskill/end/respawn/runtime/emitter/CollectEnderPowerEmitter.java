...
public final class CollectEnderPowerEmitter extends TimedRespawnEmitter {
    ...
    private static final int MAX_ACTIVE_MAIN = 8000;
    private static final int MAX_ACTIVE_FLASH = 512;
    ...
    private int countMin = 360;
    private int countMax = 1080;
    ...
    private int tickSpiral(ServerLevel level, Vec3 target) {
        ...
        while (it.hasNext()) {
            ...
            float size = Mth.clamp(p.baseSize * vis * 3.5f, 0.4f, 4.0f);
