...
public final class SwordAuraBarrage extends AbstractBarrage {
    ...
    private final AuraControler controler;

    public SwordAuraBarrage(Vec3 loc, ServerLevel world, HitBox hitBox, BarrageOption options) {
        this(new AuraControler(world, loc), loc, world, hitBox, options);
    }

    private SwordAuraBarrage(
            AuraControler controler,
            Vec3 loc,
            ServerLevel world,
            HitBox hitBox,
            BarrageOption options
    ) {
        super(loc, world, hitBox, controler, options);
    ...
    public void tick() {
        ...
        controler.setPosition(getLoc());
        controler.setDirection(getDirection());
        controler.tick();
        spawnWake();
    }
    ...
    private static final class AuraControler implements ServerControler<AuraControler> {
        ...
        private AuraControler(ServerLevel world, Vec3 position) {
            this.world = world;
