package com.reiasu.reiparticleskill.particles.display.style;
...
public final class RailgunChargingRingStyle extends ParticleGroupStyle {
    ...
    public Map<String, ParticleControlerDataBuffer<?>> writePacketArgs() {
        ...
        args.put("age", ParticleControlerDataBuffers.INSTANCE.intValue(age));
        args.put("maxAge", ParticleControlerDataBuffers.INSTANCE.intValue(maxAge));
        return args;
    }
    ...
    public void readPacketArgs(Map<String, ? extends ParticleControlerDataBuffer<?>> args) {
        if (args == null) return;
        ParticleControlerDataBuffer<?> ageBuf = args.get("age");
        if (ageBuf != null && ageBuf.getLoadedValue() instanceof Number n) {
            age = Math.max(0, n.intValue());
        }
        ParticleControlerDataBuffer<?> maxAgeBuf = args.get("maxAge");
    ...
    public static final class Provider implements ParticleStyleProvider<RailgunChargingRingStyle> {
        ...
        public RailgunChargingRingStyle createStyle(UUID uuid,
                                                     Map<String, ? extends ParticleControlerDataBuffer<?>> args) {
