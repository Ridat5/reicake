...
public final class LargeMagicCircleStyle extends ParticleGroupStyle {
    ...
    public void readPacketArgs(Map<String, ? extends ParticleControlerDataBuffer<?>> args) {
        ...
        ParticleControlerDataBuffer<?> ageBuffer = args.get("age");
    ...
    public static final class Provider implements ParticleStyleProvider<LargeMagicCircleStyle> {
        ...
        @Override
        public void changeStyle(LargeMagicCircleStyle style, Map<String, ? extends ParticleControlerDataBuffer<?>> args) {
            style.readPacketArgs(args);
        }
    }
}
